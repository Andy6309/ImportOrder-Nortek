...
Public Class Form1
        ...
        If openFileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Try
                ...
                For i As Integer = 1 To lines.Length - 1
                    ...
                    Try
                        If fields.Length >= 17 Then
                            Dim PartName As String = fields(1).Trim()
                            Dim Material As String = fields(6).Trim()
                            Dim Thickness As String = fields(7).Trim()
                            Dim Machine As String = fields(3).Trim()
                            Dim DrawingFile As String = fields(9).Trim()
                            Dim Turret As String = fields(10).Trim()
                            ...
                            Else
                                ...
                                Dim applyPerimeter As Boolean = False
                ...
                If foundFiles.Count > 0 Then
                    Dim message As String = "The following .cp files were already found:" & Environment.NewLine & String.Join(Environment.NewLine, foundFiles)
        ...
        Try
            ...
            For i = 1 To lines.Length - 1
                ...
                If fields.Count >= 17 Then
                    ...
                    ' Ensure the part exists (check if the part .cp file exists)
                    ...
                    'Ensure .cp files exists
                    ' If PartNCX.Exist(cpFiles) Then
                    '    PartNCX.Read(cpFiles)
                    '  End If

                    ' Else
                    '   MessageBox.Show($"Part file {partName} does not exist.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    '   Continue For ' Skip to the next line if the part doesn't exist
                    ' End If
                ...
                For i = 1 To lines.Length - 1
                    ...
                    If fields.Length >= 17 Then
                        ...
                        If existingFile IsNot Nothing Then
                            ' Show where the .cp file was found (Just for debugging)
                            'MessageBox.Show($"Found {partName}.cp at {existingFile}", "File Found", MessageBoxButtons.OK, MessageBoxIcon.Information)
                            ...
                            For j = 0 To quantity - 0 ' Adjust to avoid saving an extra file
                                ...
                                ' Show where the file is being saved (Just for debugging)
                                'MessageBox.Show($"Saving {newPartName}.cp to {savePath}", "Saving File", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Try
            Dim convertedFilePath = Path.Combine(Path.GetDirectoryName(originalFilePath), $"Converted_{Path.GetFileName(originalFilePath)}")
            If File.Exists(convertedFilePath) Then
                ...
                Application.Exit()
            Else
                MessageBox.Show("The specified converted file does not exist.", "File Not Found", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
